...
import { FaBriefcase, FaCog, FaUser } from 'react-icons/fa';
  ...
  return (
    <Box as="section" sx={styles.featured}>
      <Container sx={styles.container}>
        <BlockTitle
          title="Veja os recursos do MEI ERP"
          text="Conheça em detalhes as funcionalidades disponíveis para controle do seu negócio"
        />
