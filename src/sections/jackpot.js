...
const JACKPOT_DATA = [
  {
    image: jackpotImage1,
    text:
      'Funcionalidade pensadas para facilitar o dia a dia dos pequenos negócios. Não perca venda e o controle.',
    heading: 'Recursos inteligentes',
  },
  {
    image: jackpotImage2,
    text:
      'Um conjuto de recursos criados para você, empreendedor MEI que precisa de agilidade e segurança.',
    heading: 'Pacote completo',
  },
];
        ...
        <Flex sx={styles.flex}>
          ...
          <Box sx={styles.content}>
            <Box sx={styles.heading}>
              <Text as="span">Recursos incríveis</Text>
              <Heading as="h3">Gerenciamento fácil e descomplicado para sua MEI</Heading>
            </Box>
