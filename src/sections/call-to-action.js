      ...
      <Container>
        <Flex sx={styles.flex}>
          <Box sx={styles.content}>
            <Text as="span">Infraestrutra inquestionável</Text>
            <Heading as="h3">
              Desenvolvido com tecnologias usadas pelos gigantes
            </Heading>
            <Text as="p">
              O sistema MEI ERP é desenolvido com tenologias também utilizadas por grandes empresas como Twitch, Github, Nike, AT&T, PlayStation, Nubank,
              Ferrari entre outros. Utilizamos ReactJS, NextJS, serviços AWS e diversas outras integrações.
            </Text>
            <Link path="#preco" sx={styles.button}>
              Veja os planos
            </Link>
          </Box>
