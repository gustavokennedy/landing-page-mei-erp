  ...
  return (
    <Box as="section" id="banner" sx={styles.banner}>
      <Container sx={styles.container}>
        ...
        <Image src={logoImage} alt="Logo - MEI ERP" />
        <Heading as="h2">Sistema para você microempreendedor descomplicar a gestão</Heading>
        <Image src={bannerImage} sx={styles.bannerImage} alt="Banner - MEI ERP - Sistema ERP para controle de pequenos negócios MEI.
